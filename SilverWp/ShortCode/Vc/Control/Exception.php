 ...
 */
/*
 Repository path: $HeadURL: https://svn.nq.pl/wordpress/branches/dynamite/igniter/wp-content/themes/igniter/lib/SilverWp/ShortCode/Form/Element/Exception.php $
...
if ( ! class_exists( 'SilverWp\ShortCode\Vc\Control\Exception' ) ) {

    /**
     * Visual Composer controls exception
     *
     * @category WordPress
     * @package SilverWp
