<?php
/*
  Repository path: $HeadURL: https://svn.nq.pl/wordpress/branches/mango/wp-content/themes/mango/lib/SilverWp/UpdateNotifier.php $
  Last committed: $Revision: 2628 $
  Last changed by: $Author: padalec $
  Last changed d9-03 17:54:46 +0200 (Śr, 03 wrz 2014) $
  ID: $Id: UpdateNotifier.php 2628 2015-04-29 17:52:45Z padalec $
 */
 ...
 * @version $Id: UpdateNotifier.php 2628 2015-04-29 17:52:45Z padalec $
 * @category WordPress
 * @package SilverWp
...
class UpdateNotifier extends SingletonAbstract {
	...
	public function showInfo() {
		...
		// Get theme data from style.css (current version is what we want)
		$theme_data = array(
			'Name' => $this->getThemeInfo('Name'),
			'Version' => $this->getThemeInfo('Version'),
		);
